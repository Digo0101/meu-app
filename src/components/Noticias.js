  ...
  return (
    <div className="noticias-container">
      <header className="noticias-header">
        <img src="/images/noticia.webp" alt="Cabeçalho Notícias" className="cabecalho-imagem" />
